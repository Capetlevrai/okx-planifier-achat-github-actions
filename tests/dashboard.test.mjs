...
assert.ok(dashboard.includes('ARRÊT D’URGENCE') && dashboard.includes('OUI — COUPER LES ACHATS'), 'web dashboard must explain the simple emergency shutdown');
...
assert.ok(report.includes("ARRÊT D’URGENCE") && report.includes('OUI — COUPER LES ACHATS'), 'Markdown dashboard must explain the simple emergency shutdown');
